...
const Vocab1Unit2 = (props) => {
    ...
    return <div className="Vocab1Unit2" style={{display: "flex", flexDirection: 'column'}}>
        <div className="para1">
            ...
            <InputTenseComponent {...InputData[0]} isSubmitted= {isSubmitted}/>
            <span> with a(n) </span>
            <InputTenseComponent {...InputData[1]} isSubmitted= {isSubmitted}/>
